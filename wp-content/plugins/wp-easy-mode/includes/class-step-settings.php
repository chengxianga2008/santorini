...
final class Step_Settings extends Step {
	...
	private function industry_field() {
		...
		$choices = $this->get_d3_choices();

		if ( ! $this->is_d3_locale() || ! $choices ) {

			$field['choices'] = wpem_get_site_industry_slugs_to( 'label' );
	...
	/**
	 * Return an array of d3 choices.
	 *
	 * @return array
	 */
	private function get_d3_choices() {

		$categories = $this->image_api->get_d3_categories();
